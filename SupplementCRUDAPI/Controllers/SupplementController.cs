...
namespace SupplementCRUDAPI.Controllers
{
    ...
    public class SupplementController : ControllerBase
    {
        ...
        [HttpGet("{id}", Name = "Get")]
        public async Task<ActionResult<Promocion>> Get(string id)
        {
        ...
        // POST: api/Supplement
        [HttpPost]
        public async Task<ActionResult<Promocion>> Create([FromBody]Promocion s)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<Promocion>> Put(string id, [FromBody] Promocion su)
        {
            var s = await _supplementService.Get(id);
            if (s == null)
            {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<Promocion>> Delete(string id)
        {
            var s = await _supplementService.Get(id);
            if (s == null)
            {
